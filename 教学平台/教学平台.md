...
~~~
TeachingMaterialCatalog(id=870264672450772992, pid=0, createTime=Thu Jul 29 11:21:07 CST 2021, createUserId=1, createUserName=系统管理员, updateTime=Thu Jul 29 11:21:07 CST 2021, updateUserId=0, updateUserName=, dataStatus=0, deptId=0, title=第一章, code=, sortNum=1, materialId=869304236700073984)
~~~



~~~
eyJhbGciOiJIUzUxMiJ9.eyJ1c2VyX2tleSI6ImVhZjUwODU2LTYwOTUtNGZlMy1iNmEyLTFjYjk5YjhkMjlhMSJ9.C_EXxrLBHKdsIfut_CBHkjjvhoq7h2ej8ERAXbQMN_xTqdNroE_KcEyaWkyhAekkiF-tZQt17eJ5_dnavH_-Bw
~~~

~~~
        select DISTINCT a.id,t.title,a.question_bank_id
        from t_question_bank_online t
                 right	join t_question_bank_online_answer a on t.id = a.question_bank_id 
~~~



```
4f072fdcf3d440a79ff24d20b527fd9d
```
...
~~~
{
  ...
  "schoolId": 1,
  "username": "root",
  "uuid": "58e58c98ea8f4dd599623e96701d649e"
}
~~~
